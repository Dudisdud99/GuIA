...
<html lang='pt-BR'>
  <head>
    ...
    <meta charset='utf-8'>
    <title>Horários IA22</title>
    <link rel='stylesheet' type='text/css' media='screen' href='assets\hia22.css'>
  ...
  <body>
    ...
    <div id="grid">
        ...
        <div class="grid"></div>
        <div class="grid"></div>
        <div class="pai" id="pai-bp">
          <div class="filho">Banco <br> de <br> dados</div>
          <div class="filho">programação <br> I</div>
        </div>
        <div class="escondida"></div>
        <div class="escondida"></div>
        <div class="escondida"></div> <!--20-->
        ...
        <div class="escondida"></div> <!--30-->

        <div class="grid">QUA</div>
        <div class="grid">Fisíca</div>
        <div class="grid">Matemática</div>
        <div class="grid">Química</div>
        <div class="grid">Geografia</div>
        <div class="grid">Filosofia</div>
        <div class="grid">Optativas</div>
        <div class="escondida"></div>
        ...
        <div class="pai" id="er">
          <div class="filho">Engenharia <br> de <br> software</div>
          <div class="filho">Redes</div>
        </div>
        <div class="escondida"></div>
        <div class="pai" id="re">
          <div class="filho">Redes</div>
